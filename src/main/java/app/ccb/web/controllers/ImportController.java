...
public class ImportController extends BaseController {
    ...
    public ModelAndView importBranchesConfirm(@RequestParam(required = false, name = "branches") String branches) throws IOException {
    ...
    public ModelAndView importEmployeesConfirm(@RequestParam(required = false, name = "employees") String employees) throws IOException {
